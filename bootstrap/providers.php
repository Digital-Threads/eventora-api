...
return [
    ...
    \Modules\Frontend\Dashboard\User\ServiceProvider::class,
    \Modules\Frontend\Dashboard\Event\ServiceProvider::class,
    \Modules\Frontend\Dashboard\Invitation\ServiceProvider::class,
    \Modules\Frontend\Dashboard\Company\ServiceProvider::class,
    \Modules\Frontend\Dashboard\Ticket\ServiceProvider::class,
];
